...
import org.jenesis.jds.controller.JdsFieldController;
...
public abstract class JdsEntity extends Jds_Entity {
    ...
    public void populate() {
        //types
        JdsFieldController.instance().populateStrings(getActionId(), stringProperties);
        JdsFieldController.instance().populateIntegers(getActionId(), integerProperties);
        JdsFieldController.instance().populateLongs(getActionId(), longProperties);
        JdsFieldController.instance().populateFloats(getActionId(), floatProperties);
        JdsFieldController.instance().populateDoubles(getActionId(), doubleProperties);
        JdsFieldController.instance().populateDates(getActionId(), dateProperties);
        //objectProperties
        JdsFieldController.instance().populateObjects(getActionId(), objectProperties);
        //arrays
        JdsFieldController.instance().populateObjectLists(getActionId(), objectArrayProperties);
        JdsFieldController.instance().populateStringArrays(getActionId(), stringArrayProperties);
        //TODO add population for other array types
        //enums
        JdsFieldController.instance().populateEnumStrings(getActionId(), enumProperties);
    }
}
