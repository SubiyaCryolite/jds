CREATE PROCEDURE proc_store_float(p_composite_key IN NVARCHAR2, p_field_id IN NUMBER, p_value BINARY_FLOAT)
AS
  BEGIN
    MERGE INTO jds_store_float dest
    USING DUAL
